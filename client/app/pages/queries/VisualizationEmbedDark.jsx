...
import "./VisualizationEmbedDark.css";
    ...
    <div className="tile__bottom-control">
      ...
      {queryUrl && (
        <span className="hidden-print">
          <Tooltip title="Open in Tonalytica">
...
function VisualizationEmbed({ queryId, visualizationId, apiKey, onError }) {
  ...
  return (
    <div className="dark_iframe tile m-t-10 m-l-10 m-r-10 p-t-10 embed__vis" data-test="VisualizationEmbed">
      {!hideHeader && (
...
routes.register(
  "Visualizations.ViewSharedDark",
  routeWithApiKeySession({
    path: "/embed/dark/query/:queryId/visualization/:visualizationId",
